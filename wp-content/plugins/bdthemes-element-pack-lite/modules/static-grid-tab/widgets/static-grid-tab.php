		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .bdt-ep-static-grid-tab-readmore svg *' => 'stroke: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .bdt-ep-static-grid-tab-readmore:hover svg *' => 'stroke: {{VALUE}};',
				],
			]
		);
						...
						wp_json_encode(array_filter([
                            ...
                            "responsive"=> [
                                [
                                    "breakpoint" => 1023,
                                    "settings"   => [
                                        "grid"   => isset($settings["columns_tablet"]) ? esc_attr($settings["columns_tablet"]) : 3,
                                    ]
                                ],
                                [
                                    "breakpoint" => 767,
                                    "settings"   => [
                                        "grid"   => isset($settings["columns_mobile"]) ? esc_attr($settings["columns_mobile"]) : 2,
                                    ]
                                ]
                            ]
				        ]))
