	...
	public function register_modal_button_controls(Module_Base $widget) {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
                    '{{WRAPPER}} .bdt-button-modal .bdt-button-icon-align-right' => is_rtl() ? 'margin-right: {{SIZE}}{{UNIT}};' : 'margin-left: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .bdt-button-modal .bdt-button-icon-align-left' => is_rtl() ? 'margin-left: {{SIZE}}{{UNIT}};' : 'margin-right: {{SIZE}}{{UNIT}};',
                ],
