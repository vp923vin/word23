	...
	public function register_dropdown_button_controls(Module_Base $widget) {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
                    '{{WRAPPER}} .bdt-button-dropdown .bdt-button-icon-align-right' => is_rtl() ? 'margin-right: {{SIZE}}{{UNIT}};' : 'margin-left: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .bdt-button-dropdown .bdt-button-icon-align-left' => is_rtl() ? 'margin-left: {{SIZE}}{{UNIT}};' : 'margin-right: {{SIZE}}{{UNIT}};',
                ],
			]
		);
